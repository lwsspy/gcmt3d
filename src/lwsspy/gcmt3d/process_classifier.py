...
class ProcessParams(object):
    ...
    def determine_all(self):
        ...
        if self.bodywave_weight is not None:
            normalization += self.bodywave_weight
    ...
    def determine_bodywave_weight(self):
        if self.mw > 7.5:
            ...
            self.bodywave_weight = float((7.5 - self.mw) / (7.5 - 6.5))
    ...
    def determine_surfacewave_weight(self):
        ...
        if self.mw > 7.5:
            ...
            self.surfacewave_weight = float((7.5 - self.mw) / (7.5 - 6.5))
    ...
    def determine_mantlewave_weight(self):
        if self.mw > 6.5:
            ...
            self.mantlewave_weight = float((self.mw - 5.5)/(6.5 - 5.5))
